...
*@version 0.6
*/
public class EntRay extends EntBase {
     ...
     */
    public EntRay(wPoint sPoint,wPoint ePoint) {
        this();
     ...
     */
    public EntRay(double xs_value,double ys_value,double xe_value,double ye_value) {
   ...
   /**
     ...
     */
    public EntRay(double xs_value,double ys_value,double zs_value,double xe_value,double ye_value,double ze_value) {
     ...
     * @param ePoint -y of start point;
     */
    public EntRay(wPoint2D sPoint,wPoint2D ePoint) {
        this(new wPoint(sPoint),new wPoint(ePoint));
    }

    /**
     * Constructor (aRay)
     * @param aRay -one object derived from class EntRay;
     */
    public EntRay(EntRay aRay) {
        ...
        this.zExtrusionDirection = aRay.zExtrusionDirection;
    }

    /**
     * Get the vectorial Radian angle of the ray. [0 -- 2*PI]
     */
    ...
    /**
     * Get the vectorial Radian angle of ray. [0 -- 360]
     */
    ...
    /**
     * getDXF()
     * @return the dxf data of entity ray.
     * <pre>Output example:
	 *   0
	 * RAY
	 *   5
